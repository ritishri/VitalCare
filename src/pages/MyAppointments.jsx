           ...
           doctors.slice(0,4).map((items,index)=>(
            <div className='grid grid-cols-[1fr_4fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
              ...
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-sm'>{items.address.line1}</p>
                <p className='text-sm'>{items.address.line2}</p>
                <p className='text-sm mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time: </span>03-Jan-2025 | 05:41 PM</p>
              </div>
