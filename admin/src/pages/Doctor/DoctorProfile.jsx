      ...
      <div>
        <div className="flex flex-col gap-4 m-5">
          ...
          <div className="flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white">
            ...
            <p className="flex items-center gap-2 text-3xl font-medium tex-gray-700">
              {profileData.name}
            </p>
            <div className="flex items-center gap-2 mt-1 text-gray-600">
              ...
              <button className="py-0.5 px-2 boder text-xs rounded-full">
...

            {
              ...
              className="px-4 py-1 border border-primary txt-sm text-gray-800 rounded-full mt-5 hover:bg-primary hover:text-white transition-all "
            >
              Save
            </button>
            :
