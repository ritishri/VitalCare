...
function Appointment() {
  ...
  // console.log("Booking appointment for doctor ID:", docId);
  ...
  const fetchDocInfo = async () => {
    if (!doctors || doctors.length === 0) {
      console.log("Doctors data not loaded yet");
      return;
    }
      ...
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button
            ...
            className="bg-primary text-white gap-3 text-sm font-light px-14 py-3 rounded-full my-6"
          >
            Book an Appointment
          </button>
        </div>
